  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] px-4 py-10 text-black">
      <div className="mx-auto max-w-xl rounded-2xl border border-red-200 bg-white p-8 shadow-sm">
        <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-red-600">Collection Error</p>
        <h1 className="mt-2 text-2xl font-serif uppercase tracking-wider">Collection Is Temporarily Unavailable</h1>
        <p className="mt-3 text-sm text-zinc-600">{error.message || 'An unexpected error occurred while loading this category.'}</p>
